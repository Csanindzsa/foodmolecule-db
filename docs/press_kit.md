...
8. Mobile scan screen after a successful label scan.
...
- Static Expo release checks cover scan upload wiring, search results, food detail image/research/AI-guide surfaces, and recent scan history context.
