  ...
  return (
    <Container maxWidth="md" sx={{ mt: 4, mb: 8 }}>
      ...
      >
        ...
        >
          {locale.errors.accountDeletedTitle}
        </Typography>
        <Typography variant="subtitle1" sx={{ textAlign: "center" }}>
          {locale.errors.accountDeletedSubtitle}
        </Typography>
      </Box>
      ...
      >
        <Box sx={{ textAlign: "center", py: 3 }}>
          ...
          <Typography
            ...
            sx={{ fontWeight: 500 }}
          >
            {locale.errors.accountDeletedHeading}
          </Typography>
          ...
          >
            {locale.errors.accountDeletedBody}
          </Typography>
          ...
          >
            ...
            <Grid item xs={12} sm={6}>
              <Button
                ...
                sx={{ py: 1.5 }}
              >
                {locale.errors.createNewAccount}
              </Button>
            </Grid>
          </Grid>
        </Box>
